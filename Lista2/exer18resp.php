        ...
        <?php
            if($_SERVER['REQUEST_METHOD'] == 'POST'){
                try{
                    ...
                    echo "O montante com juros compostos é: R$".number_format($jurosc, 2, ",", ".").".";
                } catch(Exception $e){
                    echo 'Erro! '.$e->getMessage();
                }
            } else{
                echo '<h3>Ops! Algo deu errado...</h3><p>Tente novamente.</p><a class="btn btn-primary" href="exer18.php" role="button">Voltar</a>';
            }
